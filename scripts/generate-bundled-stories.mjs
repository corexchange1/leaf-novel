...
const appVersionName = '1.30';
const appVersionCode = 31;
const releaseTag = '1.29.1';
const releaseBaseUrl = `https://github.com/corexchange1/leaf-novel/releases/download/${releaseTag}`;
